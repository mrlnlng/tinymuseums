...
import { LAYOUTS, composeLayout } from '../media/layouts.ts'
...
/*  Reads and writes for an artist's own work: their pieces, their display, and the page a QR code lands on. */
...
/* Saves which works hang and how they are arranged, then hands compositing to the worker; the composition is stored so a drag-and-place composer can later write the same field. */
