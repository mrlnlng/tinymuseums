...
import { clearSessionCookie, requireArtist, setSessionCookie, SESSION_COOKIE } from '@/lib/session'
import { cookies } from 'next/headers'

/**
 * Studio mutations.
 *
 * Plain server actions that redirect with a message, rather than client state:
 * the studio is a handful of forms, and every one of them is a navigation.
 */
