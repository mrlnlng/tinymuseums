...
/**
 * Session plumbing for the studio.
 *
 * One httpOnly cookie holding an opaque token; the session row in Postgres is
 * the source of truth. Cognito replaces artistForSession later and nothing
 * else here changes.
 */
